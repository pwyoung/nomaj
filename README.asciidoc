...
# - For the VMs to be configured (with packages, networking, etc)
# - For Ansible to be installed on the first VM 
# - For Kubespray to be installed and configured on the first VM
# - For Kubespray to be run on the first VM which configures and runs K8S on all VMs
